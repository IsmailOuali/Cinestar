    ...
    <div class="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
        <div class="relative flex h-16 items-center justify-between">
            ...
            <div class="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start overflow-hidden">
                <a class="flex" href="">
                    <img class="rotate-45 mix-blend-multiply" src="{{ '/assets/logo/ms-icon-310x310.png' }}" alt=""
                         width="50" class="mr-2">
                ...
                <div class="hidden sm:ml-6 sm:block my-auto">
                    <div class="flex space-x-4 items-center">
                        <a href=""
                           class="{{ Request::is('/') ? 'bg-purple-500 text-white' : 'text-gray-700 hover:bg-purple-600 hover:text-white' }} rounded-md px-3 py-2 text-sm font-medium"
                           aria-current="page">Top Movies</a>
                        <a href=""
                           class="{{ Request::is('movies') ? 'bg-purple-500 text-white' : 'text-gray-700 hover:bg-purple-600 hover:text-white' }} rounded-md px-3 py-2 text-sm font-medium">Movies</a>
                        <a href=""
                           class="{{ Request::is('upcoming') ? 'bg-purple-500 text-white' : 'text-gray-700 hover:bg-purple-600 hover:text-white' }} rounded-md px-3 py-2 text-sm font-medium">Upcoming</a>
                        <a href=""
                           class="{{ Request::is('nowplaying') || Request::is('booking*') ? 'bg-purple-500 text-white' : 'text-gray-700 hover:bg-purple-600 hover:text-white' }} rounded-md px-3 py-2 text-sm font-medium">Now
                            Playing</a>
            ...
            <div class="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                ...
                @auth
                    <a href="{{route('main.seats.ticket')}}">
                        <button type="button"
                    ...
                    <div id="dropdownAvatarName" class="z-20 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
                        ...
                        <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownInformdropdownAvatarNameButtonationButton">
                            @can('admin')
                                <li>
                                    <a href=""
                                       class="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-600 hover:text-white">Dashboard</a>
                                </li>
                            @endcan
                            <li>
                                <a href=""
                            ...
                            <li>
                                <a href=""
                                   class="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-600 hover:text-white">Top Up</a>
                            </li>
                        </ul>

                        <div class="py-2">
                            <a href="" class="block px-4 py-2 text-sm text-gray-700 hover:bg-red-500">
                                Sign out</a>
                        </div>
                    </div>
                @else
                    {{-- <a href="                                  class="uppercase bg-sky-500 rounded-md text-white group-hover:drop-shadow-lg px-5 py-2 duration-200 font-inter">Login</a> --}}
                    <button id="dropdownAvatarNameButton" data-dropdown-toggle="dropdownAvatarName"
                            class="flex items-center ml-3 text-sm pe-1 font-medium text-gray-900 rounded-full hover:text-blue-600 md:me-0 focus:ring-4 focus:ring-gray-100"
                            type="button">
                        <span class="sr-only">Open user menu</span>
                        <img class="w-8 h-8 me-2 rounded-full" src="/assets/guest.jpeg" alt="user photo">
                        Guest
                        <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none"
                             viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <div id="dropdownAvatarName" class="z-20 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44">
                        <ul class="py-2 text-sm text-gray-700" aria-labelledby="dropdownInformdropdownAvatarNameButtonationButton">
                            <li>
                                <a href=""
                                   class="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-600 hover:text-white">Sign In</a>
                            </li>
                        </ul>

                        <div class="py-2">
                            <a href="" class="block px-4 py-2 text-sm text-gray-700 hover:bg-green-400">
                                Register</a>
                        </div>
                    </div>
                @endauth
